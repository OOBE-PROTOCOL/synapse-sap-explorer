...
description: Validate agent manifests, environment variables, and SDK inputs at runtime with Zod. SDK v0.20.0 aligned.
---
...
- **[Endpoint Validation](/docs/sdk/endpoint-validation)** — HTTP endpoint checks
- **[Security](/docs/best-practices/security)** — Input validation patterns
- **[CLI Reference](/docs/sdk/cli-reference)** — Terminal-based validation
