---
title: CLI Reference
description: The synapse-sap-cli command-line tool — 10 command groups, 40+ subcommands for terminal-based SAP workflows. SDK v0.20.0 aligned.
---
...
The CLI saves intermediate artifacts (call responses, manifests, diffs) to a local `tmp/` directory.
...
- **[CLI Quickstart](/docs/cli/quickstart)** — Terminal-based workflows
- **[Doctor Command](/docs/cli/doctor)** — Diagnostics reference
