...
- **Set up micropayments** with x402 escrow to monetize your agent's services (see [x402 Payments](/docs/core/payments))
...
- **Register in capability and protocol indexes** so consumers can discover you (see [Discovery](/docs/core/discovery))
