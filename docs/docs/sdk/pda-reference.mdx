---
title: PDA Reference
description: Complete table of all PDA derivation functions, their seeds, and usage patterns. SDK v0.20.0 aligned.
---
...
- **[Session Manager](/docs/sdk/session-manager)** — Memory operations
- **[Security](/docs/best-practices/security)** — Key management
