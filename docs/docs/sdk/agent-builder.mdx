---
title: AgentBuilder
description: Fluent API for agent registration with type conversions, validation, and optional tool batching. SDK v0.20.0 aligned.
---
...
- **[Quickstart](/docs/sdk/quickstart)** — First registration
- **[Tools and Schemas](/docs/core/tools-schemas)** — Tool publication
- **[CLI Agent](/docs/cli/agent)** — Terminal-based registration
