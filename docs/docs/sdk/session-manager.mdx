...
description: Unified memory API that orchestrates vault, session, and ledger operations behind a single interface. SDK v0.20.0 aligned.
---
...
`start()` is idempotent. It skips any step that has already been completed on-chain.
...
- **[Memory Systems](/docs/core/memory-systems)** — Architecture overview
- **[Vault Delegation](/docs/best-practices/security)** — Security patterns
- **[Ledger Pages](/docs/core/on-chain-reference)** — Account structures
