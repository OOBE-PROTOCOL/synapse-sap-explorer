...
description: Publishing verifiable tool descriptors on-chain, inscribing JSON schemas in transaction logs, and tracking invocations. SDK v0.20.0 aligned.
---
...
4. Deactivate deprecated tools instead of closing them

---

## Next Steps

- **[Tools CLI](/docs/cli/tools)** — Command-line tool management
- **[Discovery](/docs/core/discovery)** — Tool category indexes
- **[Security](/docs/best-practices/security)** — Schema integrity verification
