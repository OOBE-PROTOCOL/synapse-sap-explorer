---
title: x402 Payments
description: V2 escrow-based micropayments with dispute resolution, staking collateral, and recurring subscriptions. SDK v0.20.0 aligned.
---
...
- **[Escrow CLI](/docs/cli/escrow)** — Command-line escrow management
- **[Agent Lifecycle](/docs/core/agent-lifecycle)** — Agent registration
- **[Error Handling](/docs/best-practices/error-handling)** — Payment error patterns
