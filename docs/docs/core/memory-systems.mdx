...
description: Two on-chain memory architectures for agent conversation data. Ledger ring buffers and encrypted Vault storage. SDK v0.20.0 aligned.
---
...
|----------|---------------|
| Conversation logs | ✅ Ledger |
| Activity tracking | ✅ Ledger |
| Context storage | ✅ Ledger |
| High-frequency writes | ✅ Ledger |
| Cost-sensitive workloads | ✅ Ledger |
| Sensitive/encrypted data | ✅ Vault |
| Hot-wallet delegation | ✅ Vault |
| Epoch-based pagination | ✅ Vault |
...
- **[SessionManager](/docs/sdk/session-manager)** — High-level API for Ledger
- **[Agent Lifecycle](/docs/core/agent-lifecycle)** — Agent registration
- **[Payments](/docs/core/payments)** — Escrow and x402
