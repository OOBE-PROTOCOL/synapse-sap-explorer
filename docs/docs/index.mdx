...
<Callout type="info">
**Latest: v0.7.0** — V2 escrows with dispute resolution, settlement security modes, agent staking, and recurring subscriptions. [See what's new →](/docs/sdk/escrow-api)
</Callout>
