...
<Callout type="info">
**Latest: v0.9.3** with the Metaplex Core bridge (`client.metaplex`), `tripleCheckLink` audit, and atomic register flows (`buildMintAndAttachIxs`, `buildRegisterSapForMplOwnerIx`, `buildRegisterBothIxs`). See [SDK Metaplex Bridge](/docs/sdk/metaplex-bridge).
</Callout>
