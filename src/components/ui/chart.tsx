...
>(
  (
    ...
    }, [label, labelFormatter, labelKey, payload, hideLabel, config])
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "grid min-w-32 items-start gap-1.5 rounded-lg border border-border/80 bg-popover px-2.5 py-2 text-xs text-popover-foreground shadow-md",
          className,
        )}
      >
        {tooltipLabel}
